    ...
    gameState: {
        attemptsLeft: 4,
        //backwards to line up with attemptsLeft as index
    ...
    init: function() {
        ...
        //sets the bomb colour to a value from the backgroundColors array attempts left as the index
    ...
    checkDigits : function() {
        ...
        // returns the correct count and the feedback string as an object
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('submit-guess').addEventListener('click', () => {
        ...
        game.setGameDigits();
        //creates an anonymous object that takes in the object from .checkDigits()
